...
if (!surface_exists(surface_1)) surface_1 = surface_create(outline_surface_w, outline_surface_h);
if (!surface_exists(surface_2)) surface_2 = surface_create(outline_surface_w, outline_surface_h);
